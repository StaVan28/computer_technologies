...
static int add_to_cpus_array (struct cpu** arr, int* size, struct cpu elem, int position) {
...
static int add_to_processors_array (int** arr, int* size, int elem, int position) {
